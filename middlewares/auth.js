...
module.exports = () => (req, res, next) => {
    ...
    async function register({ name, username, password, repeatPassword }) {
        const existingName = await userService.getUserByNames(name);
    ...
    function createToken(user) {
        const userViewModel = { _id: user._id, name: user.name, username: user.username };
